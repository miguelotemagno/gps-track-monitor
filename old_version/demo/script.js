$(document).ready(function(){
	...
	var Tabs = {
		'Tab one'	: '../controlador/demo.php?op=1',
		'Tab two'	: 'pages/page2.html',
		'Tab three'	: 'pages/page3.html',
		'Tab four'	: 'pages/page4.html',
                'Tab five'	: 'pages/page4.html',
                'Tab six'	: 'pages/page4.html',
                'Tab seven'	: 'pages/page4.html'
	}
	
	/* The available colors for the tabs: */
	var colors = ['blue','blue','blue','blue','blue','blue','blue','blue'];

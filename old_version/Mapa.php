...
<link id="jQueryUICssSrc" type="text/css" href="css/redmond/jquery-ui-1.8.1.custom.css" rel="stylesheet" />
...
<link href="css/ui-gMapDirections.css" rel="stylesheet" type="text/css" media="all" />
  <link href="css/mbExtruder1.css" media="all" rel="stylesheet" type="text/css">
<script type="text/javascript" src="ui/ui.progressbar.js"></script>
<script type="text/javascript" src="lib/MapaClass.js"></script>
...
<link rel="stylesheet" href="css/ui.achtung-min.css" type="text/css" media="screen" charset="utf-8" />


        <script src="js/ui.achtung-min.js" type="text/javascript" charset="utf-8"></script>
...
multiple: false,noneSelectedText:'Seleccionar Patente',minWidth: 225,
    ...
    shadow:true });
        ...
        $(function(){
                <?php require('controlador/addpatente.php');
...
?>
        ...
        $('#jQueryUICssSwitch').combobox({
            ...
            list: [
                    ...
                    { value: "redmond", text: "redmond", selected: true },
...
function msng(mensaje){
                ...
                $('#test1').jGrowl(mensaje, {
					glue: 'before',
                                        closer: false,theme: 'flora',

					sticky: true,
                                         header: 'Alerta Fuera de Hora!',
					...
					//	alert("I have been closed!"+e+m+o);
					}
,
...
<script type="text/javascript">
    function detener(){
        if (statusalert){
        statusalert=false;}else{statusalert=true;}
    }
function create( template, vars, opts ){
 ...
 function valpatente(){
     if (vehiculosElegidos.length<=0)
         return false;else return true;
     
 }

 function createNewSticky(msg)
    {
        $.achtung({
            className: 'achtungSuccess',
            
            timeout: 4,
            message: msg + "<br> Alerta Nro:"+achtungCount++
        });
        ...
        $container = $("#container3").notify();

$("#default").click(function(){
		create("default", { title:'Default Notification', text:'Example of a default notification.  <a href="#" class="ui-notify-close">Close me.</a> I will fade out after 5 seconds', icon:'img/alert.png'}, {
			speed:350,expires:false,click: function(e,instance){
    ...
    contentString += "<br />" + "Coordinate: " + i + "<br />" + xy.lat() +"," + xy.lng();
     ...
     $('#datepicker2').datepicker({
        ...
        changeMonth: true,
			changeYear: true,
                        onClose:function() {
                            fechElegida=document.getElementById('datepicker2').value;
                            var MapaApp=new MapaJSClass("g",document.getElementById('datepicker2').value,vehiculosElegidos);
                            MapaApp.BuscarMain();
...
echo $menu->SinRegistro('no hay registro','No Registro en esta Fecha/Hora');
...
echo $menu->DefauldDialogo('GridreporteMax', 'Reporte Velocidad Maxima', '<div id="pageContent2"></div>');
$fun='';
echo $menu->GetJSScript('velmaxRepo', 'GridreporteMax', 250, 550, 'true', $show, $hide, 'true', 'true', '', $NomBoton2, $fun, $func2, $posicion);
...
cargarPagina(\'reportes/repMaxVelocidad.php?fecha=\'+lm.value,\'pageContent2\');';
echo $menu->GetJSScript('velmax', 'reporteMax', 150, 200, 'true', $show, $hide, 'false', 'false', 'Consultar', $NomBoton2, $fun, $func2, $posicion);


echo $menu->DefauldDialogo('GridreporteDetenido', 'Reporte Vehiculo Detenido', '<div id="pageContent"></div>');
$fun='';
echo $menu->GetJSScript('Repoeldetenido', 'GridreporteDetenido', 250, 550, 'true', $show, $hide, 'true', 'true', '', $NomBoton2, $fun, $func2, $posicion);





echo $menu->DefauldDialogo('reporteDetenido', 'Ingrese Fecha', '<br><input id="fechdetenido" type="text" name="fechamax" value="" />');
...
';
echo $menu->GetJSScript('veldetenido', 'reporteDetenido', 200, 200, 'true', $show, $hide, 'true', 'true', 'Consultar', $NomBoton2, $fun, $func2, $posicion);
...
$func1='if(valpatente()){}else{

SelecPatente();}';
echo $menu->DefauldDialogo('SelecPatentes', 'Seleccione Vehiculo a ver!', $r.'');
echo $menu->GetJSScript('SelecPatente', 'SelecPatentes', 300, 350, 'true', $show, $hide, 'false', 'false', 'Continuar', $NomBoton2, $func1, $func2, $posicion);

echo $menu->DefauldDialogo('Cantidad_Seleccionada', 'Seleccione Vehiculo a ver!', '');
echo $menu->GetJSScript('Cantidad_Seleccionada', 'Cantidad_Seleccionada', 300, 350, 'true', $show, $hide, 'false', 'false', 'Continuar', $NomBoton2, $func1, $func2, $posicion);
...
<script>
    $(function() {
		...
		$("#slider").slider({step:1000,value:10000,max:60000,min:1000,slide: function(event, ui) {
				$("#amount").val(ui.value/1000+' Seg');
...
$.idleTimeout('#segu', '', {
	...
	onCountdown: function(counter){
		$countdown.html('Proximo en :'+counter+' seg.'); // update the counter
	},
	onResume: function(){
...
var contentString="";
  ...
  */
  ...
  <div id="test1" class="jGrowl bottom-right"></div>
    <div id="none"></div>
</html>
<script>SelecPatente();dd();</script>
<?php
} else {

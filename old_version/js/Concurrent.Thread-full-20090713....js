...
var slice2 = Array.prototype.slice2;


function arrayize ( o ) {
    if ( !o ) return [];
    try {
        return slice2.call(o, 0);
    } catch ( e ) {
        var r = [];
...
proto.slice2 = function ( start, end ) {
...
var original_slice2 = proto.slice2;
proto.slice2 = function ( start, end ) {
        ...
        && start.isBoundTo(this) && end.isBoundTo(this)  )
    {
        ...
        return original_slice2.apply(this, arguments);
    }
};
...
function doNext ( ) {
    ...
    try {
        current_thread = this;
        var limit = (new Date).valueOf() + Thread.TIME_slice2;
        do {
            try {
...
Thread.create = function ( f /* , ... */ ) {
    ...
    return f.async(null, Array.prototype.slice2.call(arguments, 1, arguments.length));
};
...
proto.call.$Concurrent_Thread_compiled = function ( this_val, args, cont ) {
    if ( typeof this_val.$Concurrent_Thread_compiled == "function" ) {
        return this_val.$Concurrent_Thread_compiled(args[0], Array.prototype.slice2.call(args, 1, args.length), cont);
    } else {
        return { continuation: cont,
                 ret_val     : this_val.apply(args[0], Array.prototype.slice2.call(args, 1, args.length)) };
    }
};
...
proto.appendStatement = function ( /* variable arguments */ ) {
    ...
    if ( this.body.isNil() ) {
        ...
        args = Array.prototype.slice2.call(arguments, 1, arguments.length);
    } else {
...
proto.getScopes = function ( ) {
    return this.scopes.slice2(0, this.scopes.length);
};

...
var markers=[];
var directionsService=null;var directionsService2=null; var kkg=0;var swg=new Array();var contg=0;var sw=0;var dir;var recorrido=new Array();var Direcc=new Array ();var tiemporecorrido=0;var delay=2000;var distancia;var gmarkers =new Array();var cont=0;var cont2=new Array();var htt=new Array ();var HORA2=new Array ();var lat=new Array();var lngg=new Array ();var lng=new Array ();var point=new Array ();var pat=new Array ();var mar=new Array ();var mod=new Array ();var fech=new Array ();var hora=new Array ();var vel=new Array ();var total=new Array();
    ...
    contentString += "<br />" + "Coordinate: " + i + "<br />" + xy.lat() +"," + xy.lng();
     ...
     $('#datepicker2').datepicker({
        ...
        changeMonth: true,
			changeYear: true,
                        onClose:function() {
                            searchLocationsNear("g",document.getElementById('datepicker').value,document.getElementById('datepicker2').value);
                            /*var contentString="";
                            var vertices = flightPath.getPath();

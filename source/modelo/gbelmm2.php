...
class gbelmm {
        ...
        function iniciamenu(){
            ...
            + \'</li>\'
            + \'<li><a href="#nogo">Buscar &#187;<!--[if gte IE 7]><!--></a><!--<![endif]-->\'
            + \'<!--[if lte IE 6]><table><tr><td><![endif]--><ul>\'
            + \'<li> <a href="javascript:opciones(5)" /> Activar Opciones Busqueda.</a></li>\'
            + \'</ul><!--[if lte IE 6]></td></tr></table></a><![endif]-->\'
            + \'</li>\'
            ...
            + \'</ul><!--[if lte IE 6]></td></tr></table></a><![endif]-->\'
            + \'</li>\'
            + \'<li><a href="#nogo">Consultas/Alertas &#187;<!--[if gte IE 7]><!--></a><!--<![endif]-->\'
            + \'<!--[if lte IE 6]><table><tr><td><![endif]--><ul>\'
            + \'<li> <a href="javascript:opciones(4)" /> Crear Ruta </a></li>\'
            + \'<li><label><a href="javascript:opciones(3);"/>Ver una Ruta </a></li>\'
            + \'</ul><!--[if lte IE 6]></td></tr></table></a><![endif]-->\'
            + \'</li>\'
            + \'<li><a href="#nogo">Avanzado &#187;<!--[if gte IE 7]><!--></a><!--<![endif]-->\'
            + \'<!--[if lte IE 6]><table><tr><td><![endif]--><ul>\'
            + \'<li> <a href="javascript:opciones(4)" /> Crear Ruta </a></li>\'
            + \'<li><label><a href="javascript:opciones(3);"/>Ver una Ruta </a></li>\'
            + \'</ul><!--[if lte IE 6]></td></tr></table></a><![endif]-->\'
        ...
        function BluidW(){
            $salida='
                ...
                var pto=gmarkers22[punto].getPoint().lat()+","+gmarkers22[punto].getPoint().lng();
                var d=direccion(pto) ;
            var label = \'<b>\' + direccion(pto) + \'</b><hr>\'
            + \'<b>Lat:</b>&nbsp;\' + gmarkers22[punto].getPoint().lat()
            + \'<b>&nbsp;Lng:</b>&nbsp;\' + gmarkers22[punto].getPoint().lng()
            + \'<b>&nbsp;ID:</b>&nbsp;\' + glabels[punto]
            +\'<form name="form5" action="javascript:removeMarker(actualmarker)">\'
        ...
        function SetRouteP(){
                ...
                var r= \'<form name="form_ruta" action="javascript:setRoutePoints()">\'
                    + \'<strong>Tipo trayecto: </strong>\'
                    + \'<input type="radio"  name="tipo" id="tipo" value="1" /> A pie\'
                    + \'<input type="radio"  name="tipo" id="tipo" value="2" checked /> En Auto\'
                    + \'<input name="ruta" type="submit" value="Calcular" />\'
                    + \'</form>\';
                ...
                var op1=2;
                var op2=1;
                if (denuevo) {op2=2;op1=1;}else{op2=1;op1=2;}

                var cadena = \'<legend><b>Opciones</b></legend>\'
                
                + \'<b>Mostrando resultados...</b>\'
                ...
                document.getElementById("directions").style.width="270px";
 ...
 document.getElementById("acciones").innerHTML = cadena+=\'\';
                break;
                case 5: //Copiar el contenido del mapa al editor XML
                ...
                cargarPagina(\'addpatente.php?user='.$_SESSION["patente"].'\',\'pat\');ver();
                initMenu();
                break;
...
case 10:
						//if (document.getElementById("edit").contentWindow.document.body.innerHTML != "") {
							alert(\'Advertencia: El resultado de esta operación se muestra en el editor XML. Si desea conservar los datos del editor deberá guardarlos ahora.\');
					//	}
						xmlfile = "";
						problemaActual = 0;
						problemas = new Array();
					...
					case 11:
						...
						indiceF = 0;
						cadena += \'<b>Introducir Fichero:</b> <form name="form3" action="javascript:loadRoutes()" enctype="multipart/form-data" method="post">\'
								  + \'<input type="file" SIZE=30 MAXLENGTH=255 name="archivo" id="archivo" value=""/>\'
    							  + \'<input type="submit" value="Aceptar">\'
								  + \'</form>\';
						document.getElementById("acciones").innerHTML = cadena;

...
Timepicker.prototype = {
    ...
    _generateHtml: function ()
    {
        ...
        html += '<span class="fragHours">00</span><span class="delim">:</span><span class="fragMinutes">01</span> <span class="fragAmpm"></span></div></div><table>';
        ...
        $('#minuteSlider').slider({
            ...
            step: 1,
            slide: function(event, ui) {
                self._writeTime('minuto', ui.value);
            },
            stop: function(event, ui) {
                $('#' + self._inputId).focus();
            }

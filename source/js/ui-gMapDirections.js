...
(function($) {
    ...
    var uigMapDirectionsTxt = {
        ...
        uiTitleBox: "Buscar Direccion"
        , uiFrom: "Desde"
        , uiTo: "A"
        , uiByCar: "En Automovil"
        , uiByWalk: "Caminando"
        , uiBicycling: "Bicicleta"
        , uiUnitImperial: "Imperial"
        , uiUnitMetric: "Kilometro"
        , uiPrint: "Imprimir"
        , uiClear: "Limpiar"
        , uiGo: "Ir"
        , uiExplain: 'Utilice este servicio para el cálculo de direcciones entre dos puntos mediante la especificación de lugar de origen, de destino, el sistema de unidad preferida y un tipo de Ruta.'
    };
/*
* jQuery widget to create themable google maps utilities
*
                ...
                .fadeTo(1, o.opacity)
                    ...
                    .find('button.ui-widget-clear')
                        ...
                        .click(function(e) {
                            ...
                            $(this).hide().siblings('button.ui-widget-print').hide();
                        })
                    .end()
